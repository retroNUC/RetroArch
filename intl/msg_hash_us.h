...
MSG_HASH(
   ...
   "Change which on-screen elements are shown/hidden. Does not disable any functionality."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Shows additional messages for internal errors/problems related to achievements."
   )
