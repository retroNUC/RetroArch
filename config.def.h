...
#define DEFAULT_CHEEVOS_VISIBILITY_LBEVENTS true
#define DEFAULT_CHEEVOS_VISIBILITY_LBTRACKER true
#define DEFAULT_CHEEVOS_VISIBILITY_UNLOCK true
#define DEFAULT_CHEEVOS_VISIBILITY_SUMMARY 1 /* CHEEVOS_VISIBILITY_SUMMARY_HASCHEEVOS */
#endif
